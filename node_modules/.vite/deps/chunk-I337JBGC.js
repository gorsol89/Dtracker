...
import {
  init_length,
  lineStringLength
} from "./chunk-TW5K5PDT.js";
import {
  RBush,
  init_rbush
} from "./chunk-LASCBSFE.js";
import {
  LinearRing_default,
  Polygon_default,
...
function toGeometry(renderFeature) {
  ...
  switch (geometryType) {
    case "Point":
      return new Point_default(renderFeature.getFlatCoordinates());
    case "MultiPoint":
      return new MultiPoint_default(renderFeature.getFlatCoordinates(), "XY");
    case "LineString":
      return new LineString_default(renderFeature.getFlatCoordinates(), "XY");
...
export {
  ...
  Feature_exports,
  init_Feature2 as init_Feature,
  VectorSourceEvent,
  Vector_default,
  Vector_exports,
  init_Vector
};
//# sourceMappingURL=chunk-I337JBGC.js.map
